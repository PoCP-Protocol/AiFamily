...
class SqlAlchemyHumanGate:
    ...
    async def pending_accepted_task_ids(self, *, limit: int = 100) -> tuple[str, ...]:
        """Return a bounded read-only list of accepted tasks awaiting delivery."""
    ...
    async def claim_accepted(
        ...
        *,
        ...
        return HumanTaskClaim(task=task, claim_owner=owner, claim_expires_at=claim_expires_at)
    ...
    async def complete_claim(
        ...
        *,
        ...
        """Clear a live claim after the owning domain command commits."""
