...
This router deliberately is not a booking or media router.  It exposes one GET
detail operation and requires explicit application composition for its source
adapter.  The clean-base task proves import and contract behavior; mounting it
in the production app is a separate composition-owner change.
"""
...
from ..application.live_queries import get_live_session_detail
