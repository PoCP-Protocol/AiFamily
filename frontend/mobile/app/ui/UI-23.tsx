      ...
      <FlatList
        ...
        ListHeaderComponent={
          <View style={styles.header}>
            <View style={styles.topBar}><Pressable onPress={() => router.back()} style={styles.topBack}><IconSymbol name="chevron.left" size={26} color={colors.text} /></Pressable><Text style={[styles.topTitle, { color: colors.text }]}>活动介绍</Text><Text style={[styles.topMore, { color: colors.text }]}>•••</Text></View>
            <View style={[styles.hero, { backgroundColor: `${activity.accent}18` }]}><View style={[styles.heroIcon, { backgroundColor: colors.surface }]}><IconSymbol name="person.2.fill" size={54} color={activity.accent} /></View><Text style={[styles.heroLabel, { color: activity.accent }]}>家庭活动资料</Text><Text style={[styles.heroHint, { color: colors.muted }]}>保存意向前，先了解主题与安排</Text></View>
...
const styles = StyleSheet.create({
  content: { paddingHorizontal: 16, paddingTop: 10, paddingBottom: 34, gap: 8 }, header: { gap: 13 }, topBar: { minHeight: 46, flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, topBack: { width: 38, height: 38, alignItems: "flex-start", justifyContent: "center" }, topTitle: { fontSize: 20, lineHeight: 28, fontWeight: "800" }, topMore: { fontSize: 18, lineHeight: 22, fontWeight: "900" }, hero: { height: 222, borderRadius: 24, alignItems: "center", justifyContent: "center", gap: 8 }, heroIcon: { width: 92, height: 92, borderRadius: 30, alignItems: "center", justifyContent: "center" }, heroLabel: { fontSize: 15, lineHeight: 21, fontWeight: "800" }, heroHint: { fontSize: 11, lineHeight: 17 }, titleBlock: { gap: 6 }, activityTag: { alignSelf: "flex-start", borderRadius: 9, paddingHorizontal: 8, paddingVertical: 4, fontSize: 10, lineHeight: 14, fontWeight: "800" }, title: { fontSize: 26, lineHeight: 36, fontWeight: "800" }, subtitle: { fontSize: 13, lineHeight: 20 },
  ...
  footer: { gap: 13, marginTop: 4 }, sectionText: { fontSize: 12, lineHeight: 19 }, boundary: { fontSize: 10, lineHeight: 16 }, receipt: { minHeight: 82, borderWidth: 1, borderRadius: 18, padding: 13, flexDirection: "row", alignItems: "center", gap: 9 }, receiptCopy: { flex: 1, gap: 3 }, receiptTitle: { fontSize: 14, lineHeight: 20, fontWeight: "800" }, receiptText: { fontSize: 11, lineHeight: 17 }, actionRow: { flexDirection: "row", gap: 9 }, consultAction: { width: 126, minHeight: 52, borderWidth: 1, borderRadius: 18, alignItems: "center", justifyContent: "center", paddingHorizontal: 8 }, consultText: { fontSize: 12, lineHeight: 17, fontWeight: "700" }, primaryAction: { flex: 1, minHeight: 52, borderRadius: 18, backgroundColor: "#F28C45", alignItems: "center", justifyContent: "center" }, loadingContent: { flexDirection: "row", alignItems: "center", gap: 7 }, disabled: { opacity: 0.78 }, primaryText: { color: "#FFFFFF", fontSize: 14, lineHeight: 20, fontWeight: "800" }, modalScrim: { flex: 1, backgroundColor: "#09295A66", alignItems: "center", justifyContent: "center", paddingHorizontal: 34 }, successModal: { width: "100%", borderRadius: 24, backgroundColor: "#FFFFFF", padding: 24, alignItems: "center", gap: 12 }, successTitle: { color: "#09295A", fontSize: 20, lineHeight: 28, fontWeight: "800" }, successText: { color: "#5D6D84", fontSize: 13, lineHeight: 20, textAlign: "center" }, successAction: { alignSelf: "stretch", minHeight: 48, borderRadius: 18, backgroundColor: "#F28C45", alignItems: "center", justifyContent: "center", marginTop: 4 }, successActionText: { color: "#FFFFFF", fontSize: 15, lineHeight: 21, fontWeight: "800" }, pressed: { opacity: 0.82, transform: [{ scale: 0.98 }] },
});
