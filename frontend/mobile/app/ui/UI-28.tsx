  ...
  return (
    <ScreenContainer edges={["left", "right", "bottom"]}>
      ...
      <ScrollView contentContainerStyle={styles.content} refreshControl={<FamilyRefreshControl />}>
        ...
        <Pressable onPress={() => router.push(routeForUi("UI-26"))} style={({ pressed }) => [styles.writeButton, pressed && styles.pressed]}><IconSymbol name="square.and.pencil" size={21} color="#FFFFFF" /><Text style={styles.writeText}>写一篇家庭小记</Text></Pressable>
      </ScrollView>
    </ScreenContainer>
  );
}
