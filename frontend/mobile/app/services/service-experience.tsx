...
// Keep these product boundaries visible in the family-facing copy and aligned
// with the existing S1 contract baseline.
const EMOTIONAL_FIRST_COPY = "先接住疲惫";
const NO_RANKING_COPY = "不展示家庭总分或排名";

const NEEDS = [
  { id: "COMMUNICATION", label: "亲子沟通", prompt: "从一句更容易说出口的话开始" },
   { id: "EMOTION", label: "情绪陪伴", prompt: `${EMOTIONAL_FIRST_COPY}，再让家庭有一个可以喘气的空间` },
