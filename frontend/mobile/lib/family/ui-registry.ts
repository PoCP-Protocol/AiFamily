...
export const FAMILY_SCREENS: FamilyScreenDefinition[] = [
  ...
  { id: "UI-03", title: "家庭理解", subtitle: "基于家庭原话的可修订解读草案，由家长确认是否贴近", tab: "growth", loop: "评估", featurePoints: ["家庭原话", "依据说明", "不确定性", "家长确认"], primaryAction: "查看家庭解读", primaryTarget: "UI-04", baseline: "core-03-ai-report" },
  { id: "UI-04", title: "21 天家庭计划", subtitle: "三个阶段，一起看见并调整家庭机制", tab: "growth", loop: "计划", featurePoints: ["关系机制", "共同决策", "冲突修复", "家庭复盘"], primaryAction: "进入家庭复盘", primaryTarget: "UI-05", baseline: "core-04-growth-plan" },
  { id: "UI-05", title: "21 天家庭复盘", subtitle: "在三个家庭机制阶段里回看观察与决定", tab: "growth", loop: "计划", featurePoints: ["关系机制", "共同决策", "冲突修复", "家庭复盘"], primaryAction: "进入家庭复盘", primaryTarget: "UI-05", baseline: "core-05-delivery-community" },
